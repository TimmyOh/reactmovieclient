...
class App extends Component {
  ...
  getAllMovies = () => {
    axios
      .get('https://hidden-mesa-40870.herokuapp.com/getallmovies')
      .then(result => {
  ...
  onSubmit = e => {
    ...
    const query = `https://hidden-mesa-40870.herokuapp.com/getallmovies?title=${
      this.state.title
    }`;
  ...
  removeMovie(title) {
    ...
    const query = `https://hidden-mesa-40870.herokuapp.com/getallmovies?title=${title}`;
    axios
      .get(query)
      .then(result => {
        this.getAllMovies();
